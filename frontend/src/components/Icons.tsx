...
export function IconCheck({ size = 20, className = '', color = 'currentColor' }: IconProps & { color?: string }) {
  return (
...
export function IconDot({ size = 20, className = '', color = 'currentColor' }: IconProps & { color?: string }) {
  return (
...
export function IconDispatch({ size = 20, className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
